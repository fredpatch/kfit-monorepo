...
2. Implement OTP challenge service foundation only.
3. Commit OTP challenge service code/tests/docs to GitHub.
4. Ask the project owner to run exact local validation commands on Windows/Git Bash.
5. Diagnose/fix any local validation failures before moving on.
6. After OTP challenge service validation, implement auth repositories/controllers/routes/middleware.
