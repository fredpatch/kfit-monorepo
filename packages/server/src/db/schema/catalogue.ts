...
export const services = pgTable("services", {
  ...
  waitlistEnabled: integer("waitlist_enabled").notNull().default(0),
...
export const servicePolicies = pgTable("service_policies", {
  ...
  lateCancelConsumesComponent: integer("late_cancel_consumes_component").notNull().default(0),
  missedConsumesComponent: integer("missed_consumes_component").notNull().default(0),
